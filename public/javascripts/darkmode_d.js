//玖叁表示我愿意用var！
const normalBackgroundColour = "#f1f3f5"; //普通背景颜色
const normalButtonColour = "#e9ecef";     //普通按钮颜色
const darkButtonColour = "#100f2c";       //dark按钮颜色
        ...
        var r = function() {
            function e(t) {
                ...
                var n = t && t.bottom ? t.bottom : "32px"
                  ...
                  , d = t && t.mixColor ? t.mixColor : normalBackgroundColour
                  , i = t && t.backgroundColor ? t.backgroundColor : normalBackgroundColour
                  , s = t && t.buttonColorDark ? t.buttonColorDark : darkButtonColour
                  , l = t && t.buttonColorLight ? t.buttonColorLight : normalButtonColour
                  , c = t && t.label ? t.label : ""
                ...
                y.innerHTML = c,
                m.classList.add("darkmode-layer"),
                b.classList.add("darkmode-background"),
                !0 === ("true" === window.localStorage.getItem("darkmode")) && u && (m.classList.add("darkmode-layer--expanded", "darkmode-layer--simple", "darkmode-layer--no-transition"),
                y.classList.add("darkmode-toggle--white"),
